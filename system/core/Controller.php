...
class Base_Controller extends CI_Controller
{
   ...
   var $userid;
    ...
    {
         $this->memberinfo = $this->session->userdata($this->config->item('sess_cookie_name'));
    ...
    public function checkown()
    {
        ...
        if(empty($this->memberinfo) && empty($userid)){

           redirect('c=login');

        }else{
            if(!empty($userid)){
                $owninfo['userid'] = $userid;
                if(!empty($this->memberinfo)){  //用户登陆
